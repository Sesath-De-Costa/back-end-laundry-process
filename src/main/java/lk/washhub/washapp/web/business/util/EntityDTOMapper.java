...
public interface EntityDTOMapper {
    ...
    RequestDTO getProcessDTO(Request request);

    List<Request> getAllRequest(List<RequestDTO> processDTOList);

    List<ProcessDTO> getAllRequestDTO(List<Request> requestList);
